  ...
  return <Section title="How it Works">
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <div className="space-y-3 rounded-xl border-lightBlue border p-4 md:pb-9 md:px-8 md:pt-[42px]">
        <TestPaperIcon />
        <p className="text-[18px] font-semibold text-[#2C3345]">Take a Test</p>

        <p className="text-sm">Get an unbiased view of yourself</p>
      </div>
      <div className="space-y-3 rounded-xl border-lightBlue border p-4 md:pb-9 md:px-8 md:pt-[42px]">
        <DetailedReportIcon />
        <p className="text-[18px] font-semibold text-[#2C3345]">Get Your Detailed Report</p>
      ...
      <div className="space-y-3 rounded-xl border-lightBlue border p-4 md:px-8 md:pt-[42px]">
        <RocketIcon />
        <p className="text-[18px] font-semibold text-[#2C3345]">Begin Your Journey</p>
