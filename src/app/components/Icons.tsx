...
export const RibbonCheckIcon = ({ className, size }: { className?: string, size?: number }) => (
...
export const ReviewsIOIcon = () => {
  return (
    <svg
      ...
      viewBox="0 0 755 121"
      className="w-[205px] h-[20px] place-self-end px-10"
    >
      <path d="M0 0h754.167v120.833H0z" style={{ fill: 'none' }} />
      <path
        d="M194.232 91.753 174.933 66.91c12.391-2.901 21.054-10.99 21.054-24.397v-.229c0-6.725-2.459-12.708-6.613-16.866-5.308-5.308-13.62-8.484-23.991-8.484h-30.616c-3.008 0-5.6 2.566-5.6 5.716v73.038c0 3.151 2.592 5.717 5.6 5.717 3.138 0 5.712-2.573 5.712-5.717V69.034h21.933l22.71 29.503c1.247 1.663 2.931 2.868 5.149 2.868 2.864 0 5.716-2.592 5.716-5.605 0-1.528-.651-2.802-1.755-4.047m-9.674-49.119.001.233h-.001c0 9.945-8.391 15.788-19.996 15.788h-24.083V27.546h24.2c12.474 0 19.879 5.593 19.879 15.088m27.917 52.471c0 3.146 2.592 5.713 5.6 5.713h51.417a5.226 5.226 0 0 0 5.246-5.25 5.224 5.224 0 0 0-5.246-5.246h-45.704v-26.55h39.862c2.917 0 5.25-2.33 5.25-5.246 0-2.771-2.333-5.25-5.25-5.25h-39.862V27.434h45.121a5.23 5.23 0 0 0 5.25-5.25 5.23 5.23 0 0 0-5.25-5.25h-50.834c-3.007 0-5.6 2.566-5.6 5.717zm109.825 6.65.613-.002c3.061-.053 4.968-1.777 6.178-4.472l31.688-73.194a5.8 5.8 0 0 0 .425-2.253c0-2.879-2.434-5.484-5.6-5.484-2.509 0-4.509 1.894-5.489 3.845l-.031.067-27.43 65.705-27.322-65.472c-.974-2.37-2.96-4.145-5.749-4.145-3.156 0-5.721 2.737-5.721 5.596 0 .999.152 1.709.575 2.559l31.528 72.754c1.099 2.74 3.18 4.496 6.335 4.496m53.872-79.689v73.621c0 3.151 2.592 5.717 5.6 5.717 3.138 0 5.712-2.573 5.712-5.717V22.066c0-3.144-2.574-5.716-5.712-5.716-3.008 0-5.6 2.565-5.6 5.716m88.584-5.13-.136-.002h-50.837c-3.003 0-5.596 2.566-5.596 5.717v72.454c0 3.146 2.592 5.713 5.596 5.713h51.42a5.23 5.23 0 0 0 5.246-5.25 5.227 5.227 0 0 0-5.246-5.246h-45.704v-26.55h39.858c2.922 0 5.25-2.33 5.25-5.246 0-2.771-2.328-5.25-5.25-5.25h-39.858V27.434h45.121a5.23 5.23 0 0 0 5.25-5.25 5.23 5.23 0 0 0-5.114-5.248m100.218 84.933h.96c2.726-.058 4.686-1.926 5.645-4.672l26.186-72.703c.261-.8.635-1.745.635-2.545 0-2.865-2.709-5.596-5.717-5.596-2.692 0-4.576 1.782-5.43 4.332l-21.654 62.284-20.424-62.282c-.846-2.544-2.72-4.334-5.542-4.334v.009l-.588-.009c-2.967 0-4.7 1.79-5.546 4.334l-20.423 62.28-21.542-62.064c-.835-2.503-2.976-4.55-5.776-4.55-3.137 0-5.829 2.718-5.829 5.713 0 .813.246 1.625.516 2.433l26.184 72.7c.963 2.878 2.924 4.616 5.645 4.67h.96c2.722-.058 4.687-1.927 5.641-4.674l20.173-59.95 20.285 59.952c.959 2.746 2.924 4.614 5.641 4.672m92.445-23.361v.233c0 7.549-6.903 12.867-17.187 12.867-10.106 0-17.609-3.063-25.104-9.413l-.021-.019c-.741-.724-2.049-1.323-3.504-1.323-3.022 0-5.488 2.435-5.488 5.6 0 1.876.884 3.46 2.174 4.345 9.299 7.379 19.434 11.189 31.593 11.189 16.898 0 28.966-9.592 28.966-24.179v-.238c0-12.96-8.567-20.031-27.461-24.151l-.004-.001c-17.165-3.68-21.38-7.517-21.38-14.877v-.233c0-6.872 6.447-12.163 16.37-12.163 7.377 0 13.844 2.05 20.541 6.929l.006.005c.997.716 2.001 1.012 3.295 1.012a5.477 5.477 0 0 0 5.479-5.483c0-2.135-1.26-3.712-2.403-4.571l-.018-.013c-7.654-5.501-15.66-8.258-26.666-8.258-16.195 0-27.921 9.968-27.921 23.362l1.042 1.042-1.042-1.035v.217l1.042 1.047-1.042-1.041c0 13.919 8.802 20.393 28.287 24.626l.006.001c16.349 3.451 20.44 7.292 20.44 14.523m24.308 11.399-.099-.001c-2.197 0-3.763 1.574-3.763 3.696l.625.625-.625-.625v1.308c0 2.119 1.569 3.763 3.763 3.763 2.117 0 3.696-1.64 3.696-3.763 0 .346-.28.625-.625.625 0 0 .625-.07.625-.654v-1.279c0-2.093-1.526-3.647-3.597-3.695m-3.182 5.619q-.053.01-.055.009.029 0 .057-.002zm16.517-29.374v29.346c0 1.79 1.386 3.175 3.17 3.175 1.8 0 3.113-1.381 3.113-3.175V66.152c0-1.795-1.385-3.175-3.175-3.175-1.711 0-3.108 1.464-3.108 3.175m-.458-11.962c0 1.919 1.571 3.304 3.567 3.304 2.073 0 3.629-1.389 3.629-3.304v-.846c0-1.997-1.556-3.309-3.629-3.309-1.996 0-3.567 1.308-3.567 3.309z"
        style={{ fillRule: 'nonzero' }}
      />
      <path
        d="m746.183 80.873.001-.142c0-9.886-7.714-18.146-18.204-18.146-10.557 0-18.275 8.396-18.275 18.275l.129.13-.129-.126v.126c0 9.882 7.651 18.141 18.142 18.141 10.556 0 18.331-8.385 18.336-18.258m-6.411.117v-.13c0-6.902-5.146-12.583-11.925-12.583-6.962 0-11.73 5.679-11.73 12.454v.129c0 6.901 5.085 12.509 11.863 12.509 6.957 0 11.792-5.605 11.792-12.379"
      />
      <path
        d="m95.146 23.399-5.024 2.52c9.794 7.909 14.582 18.125 15.472 30.487-.744 23.861-12.002 39.197-31.341 45.774-22.343 6.732-36.501 1.285-50.201-12.674l-.863 5.366 5.57 5.804c19.375 20.191 51.498 20.854 71.689 1.479 20.191-19.376 20.854-51.498 1.478-71.69z"
        style={{ fill: '#feef7c' }}
      />
      <path
        d="m20.433 91.882 3.366-2.94C9.814 69.124 9.228 40.11 28.367 24.137c14.187-11.84 42.337-17.977 64.858 1.852l1.681-2.957-5.488-5.72C70.042-2.879 37.92-3.542 17.728 15.834-2.463 35.209-3.125 67.332 16.25 87.523z"
        style={{ fill: '#5cd3cb' }}
      />
      <path
        d="M8.333 59.138c0 28.054 22.746 50.8 50.8 50.8 28.059 0 50.804-22.746 50.804-50.8 0-28.059-22.745-50.805-50.804-50.805-28.054 0-50.8 22.746-50.8 50.805m35.359 9.188a4.17 4.17 0 0 0-1.48-4.593L26.058 51.669a2.083 2.083 0 0 1 1.247-3.752h19.306a4.17 4.17 0 0 0 3.956-2.857l6.553-19.789a2.083 2.083 0 0 1 3.953-.006l6.625 19.807a4.17 4.17 0 0 0 3.952 2.845h19.355a2.082 2.082 0 0 1 1.253 3.747L76.123 63.817a4.17 4.17 0 0 0-1.466 4.586l6.327 19.978a2.085 2.085 0 0 1-3.255 2.282L61.634 78.309a4.166 4.166 0 0 0-5.086.009L40.631 90.625a2.083 2.083 0 0 1-3.261-2.275z"
        style={{ fillRule: 'nonzero' }}
      />
    </svg>
  );
...
export const LiberiaFlagIcon = ({ size }: { size?: number }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
  ...
  >
    ...
    {/* White stripes */}
    <path id="stripe" d="M0 1300h2800v100H0z" fill="#fff" />
    <use href="#stripe" transform="translate(0 -200)" />
    <use href="#stripe" transform="translate(0 -400)" />
    <use href="#stripe" transform="translate(0 -600)" />
    <use href="#stripe" transform="translate(0 -800)" />
    <use href="#stripe" transform="translate(0 -1000)" />
    <use href="#stripe" transform="translate(0 -1200)" />

    {/* Blue box */}
    <path d="M0 0h1400v800H0z" fill="#010066" />

    {/* Yellow circle background for emblem */}
    <path
...
export const PHFlagIcon = ({ sizeW, sizeH }: { sizeW?: number; sizeH?: number }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      xmlnsXlink="http://www.w3.org/1999/xlink"
      viewBox="0 0 180 90"
      width={sizeW ? `${sizeW}px` : '180px'}
      height={sizeH ? `${sizeH}px` : '90px'}
    >
...
export const NatoFlagIcon = ({ size }: { size?: number }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="-60 -40 240 160"
    width={size ? `${size}px` : '55px'}
    height={size ? `${size}px` : '32px'}
  >
    <rect width="100%" height="100%" x="-60" y="-40" fill="#fe0000" />
    <rect width="50%" height="50%" x="-60" y="-40" fill="#000095" />

    <path id="a" fill="#fff" d="M8 0 0 30 -8 0 l8 -30 M0 8 l30 -8 L0 -8 l-30 8" />
