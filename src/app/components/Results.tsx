    ...
    <>
      <Section title="Latest results" className="md:pt-12 md:pb-0">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 px-4 md:px-0">
          ...
          `}>
              <div className="flex items-center gap-3 md:gap-4 px-3 py-3 sm:py-0 sm:pl-4 w-full">
                ...
                <div className="text-[#0D0D0E] text-base md:text-lg font-medium">{result.name}</div>
                <div className="ml-auto text-[18px] md:text-[20px] text-[#006FEE] font-semibold mr-2 md:mr-7">IQ {result.IQ}</div>
              </div>
            </div>
          ))}
        </div>
